...
model.prototype.save = function(callback){
  ...
  if (typeof this._id !== "undefined") {
    ...
    this.constructor.update({_id: this._id}, {$set: $set}, {upsert: true}, promise.fulfill.bind(promise));
  } else {
    ...
    if (typeof original_cb === "function") {
      args[args.length - 1] = function(error, data){
        ...
        if (data && typeof data !== "number")
          return this._load(data, promise.fulfill.bind(promise));
